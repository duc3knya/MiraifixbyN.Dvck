...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["chào bạn tôi là bot của Trịnh Long Vũ", "bạn gọi tôi có việc gì?", "tôi yêu bạn vai lon", "Yêu em <3", "Hi, chào con vợ bé:3", "Vợ gọi có việc gì không?", "Sử dụng callad để liên lạc với admin!", "Em là bot cute nhất hành tinh", "Nói gì thế con lợn", "Em đây~~~~", "Yêu chị VŨ nhất", "chị Long là bae của Vũ", "Yêu thương admin nhất", "Em là phụ trợ của admin", "Sao thế công chúa", "Đừng làm em đau ~~~~", "Rên với em nhé a á á á", "Tuyển phi công nè ạ", "Cậu cô đơn ko?", "Chịch ko ạ vã quá!!!", "Được của ló =)))", "Em dthw như chủ của em ạ", "Đừng khen em ngại quá hí hí" ,"Làm vợ em ko ạ?", "Đừng spam em nha :<<, cô chủ em mệt lắm ời", "Đừng đè em mạnh!!!", "Đút tutu thôi em đau :'(", "Yêu cậu như một cực hình\nNhấp lên nhấp xuống hai mình cùng rên", "Yêu em ko?", "Chồng em đây rồi","Bạn có ngiu chưa??","Đừng spam em :<","Yêu chị Vũ ko nè??","Yêu chị Demons ko nè??","Yêu chị Lonk ko nè??"];
  var rand = tl[Math.floor(Math.random() * tl.length)]

  if ((event.body.toLowerCase() == "bot ngu")) {
    return api.sendMessage("Thành viên đã cố ý chửi bot, do đó đã vi phạm luật bot nên bot sẽ out và muốn add lại thì xin liên hệ qua admin qua Fb: TRịnh Long Vũ để được hỗ trợ\nLink fb nè: https://www.facebook.com/demons.vu.09/\n👀🐾Trịnh Long Vũ/", threadID, () =>
  ...
  if ((event.body.toLowerCase() == "ôi") || (event.body.toLowerCase() == "oi")) {
    return api.sendMessage("Tt đi nào bạn ơi!!", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ơi") || (event.body.toLowerCase() == "oi")) {
    return api.sendMessage("Biết ơi à?? Cậu xứng đáng làm ngiu của mình :>", threadID);
  };

  if ((event.body.toLowerCase() == "ừ") || (event.body.toLowerCase() == "u")) {
    return api.sendMessage("Đừng cục súc vậy, tương tác điii", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "vũ") || (event.body.toLowerCase() == "vun")) {
    return api.sendMessage("Anh ấy là admin của 𝕭𝖔𝖙 𝖔𝖋 vũ, dù không đẹp nhưng cũng được nhá :> ", threadID);
  };

  if ((event.body.toLowerCase() == "Vũ) || (event.body.toLowerCase() == " vu ")) {
    return api.sendMessage("Anh ấy là admin của 𝕭𝖔𝖙 𝖔𝖋 vũ, dù không đẹp nhưng cũng được nhá :> ", threadID);
  };

  if ((event.body.toLowerCase() == "trinh long vu") || (event.body.toLowerCase() == "vun")) {
  ...
  if ((event.body.toLowerCase() == "@Trịnh Long Vũ") || (event.body.toLowerCase() == "@Trịnh Long Vũ")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://www.facebook.com/demons.vu.09", threadID);
  };

  if ((event.body.toLowerCase() == "bot ơi") ||  (event.body.toLowerCase() == "bot ơi")) {
    return api.sendMessage("Sao cậu???", threadID);
  };

  if ((event.body.toLowerCase() == " ibot") || (event.body.toLowerCase() == "yeu bot")) {
    return api.sendMessage("Hmm... Bot ngại lắm thôi yêu admin của bot và Anh Long Vũ nhé :))", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "cứu") || (event.body.toLowerCase() == "cuu")) {
    return api.sendMessage("Cứu làm gì?? ngu thì chết khôn thì sống Cậu chủ bảo tao thế <3", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Trịnh Long Vũ có gì dùng lệnh /ad hoặc /adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "cặc") || (event.body.toLowerCase() == "cặc")) {
    return api.sendMessage("️Văn minh lên nào, sao lại chửi tục??", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Vũ") || (event.body.toLowerCase() == "Anh Vũ")) {
  ...
  if ((event.body.toLowerCase() == "cc") ||  (event.body.toLowerCase() == "cc")) {
    return api.sendMessage("Văn minh lên nào, sao lại chửi tục?", threadID);
  };
