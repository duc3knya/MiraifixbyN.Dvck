...
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 12500);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 13000);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 13500);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 14000);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 14500);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 15000);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 15500);
setTimeout(() => {a({body: "ra đây donate vào momo 0977537296 đi" + " " + name, mentions: arraytag})} , 16000);
setTimeout(() => {a({body: "ra đây chơi em" + " " + name, mentions: arraytag})} , 16500);
setTimeout(() => {a({body: "ra đây chơi với Vũ cute điii" + " " + name, mentions: arraytag})} , 17000);
setTimeout(() => {a({body: "ra đây chơi với anh Vũ đẹp trai nào" + " " + name, mentions: arraytag})} , 17500);
...
setTimeout(() => {a({body: "ra chơi với admin Vũ chim dài" + " " + name, mentions: arraytag})} , 20500);
