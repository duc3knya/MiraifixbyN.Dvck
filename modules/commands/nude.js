...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`[Admin Trịnh Long Vũ ] á à tao bắt được 1 đứa tà dâm😼 Ảnh nude\nSố Ảnh: ${link.length}\n Số dư -250000 đô nha!`,attachment: fs.createReadStream(__dirname + "/cache/10.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/10.jpg"), event.messageID); 
